...
Install and use the DSQL Loader from the [aurora-dsql-loader project](https://github.com/aws-samples/aurora-dsql-loader), then run `aurora-dsql-loader` directly.
